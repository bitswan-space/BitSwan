    ...
    def __init__(self, app, pipeline_id=None):
        ...
        self.build(
            bspump.random.RandomSource(
                app, self, choice=["a", "b", "c"], config={"number": 1000000}
...
class HyperLogLogTimeWindowCounter(bspump.analyzer.SessionAnalyzer):
    def __init__(self, app, pipeline, id=None, config=None):
        ...
        super().__init__(
            ...
            dtype="({},)i2".format(self.HLLAggregator.m),
            id=id,
            config=config,
        )
    ...
    def analyze(self):
        ...
        L.warning(
            "Ground Truth is {}, HyperLogLog estimation is {}, error is {} %".format(
                ground_truth, hll_count, error
            )
        )
