...
class SlaveApplication(bspump.BSPumpApplication):
    def __init__(self):
        ...
        self.Lookup = MyMatrixLookup(
            self,
            matrix_id="MySessionMatrix",
            id="MyLookup",
            config={
                "master_url": "http://localhost:8080",
                "master_lookup_id": "MyLookup",
            },
        )
    ...
    def __init__(self, app, pipeline_id=None):
        ...
        self.build(
            bspump.random.RandomSource(
                app, self, config={"number": 10, "upper_bound": 10}
            ...
            bspump.random.RandomEnricher(
                app, self, choice=channel_choice, config={"field": "channel"}, id="RE1"
            ),
            Enricher(app, self),
