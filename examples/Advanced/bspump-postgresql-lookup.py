...
class MyApplication(bspump.BSPumpApplication):
    ...
    def __init__(self):
        ...
        pgsql_connection = bspump.postgresql.PostgreSQLConnection(
            self,
        ...
        self.postgres_lookup = bspump.postgresql.PostgreSQLLookup(
            self,
    ...
    def __init__(self, app, pipeline_id=None):
        ...
        self.build(
            bspump.file.FileCSVSource(
                app, self, config={"post": "noop", "path": "./data/users.csv"}
