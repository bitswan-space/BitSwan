...
class LDAPPipeline(bspump.Pipeline):
    def __init__(self, app, pipeline_id):
        ...
        self.build(
            bspump.ldap.LDAPSource(app, self, "LDAPConnection").on(
                bspump.trigger.PubSubTrigger(app, "RunLDAPPipeline!")
            ),
...
if __name__ == "__main__":
    ...
    svc.add_connection(bspump.ldap.LDAPConnection(app, "LDAPConnection"))
