...
class SamplePipeline(bspump.Pipeline):
    def __init__(self, app, pipeline_id=None):
        ...
        self.jsonfilename = (
            datetime.datetime.now().strftime("%d-%m-%Y") + self.fileextjson
        )
...
if __name__ == "__main__":
    ...
    svc.add_connection(
        bspump.mongodb.MongoDBConnection(
            app, "MongoDBConnection", config={"host": "mongodb://127.0.0.1:27017"}
        )
    )
